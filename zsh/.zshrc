...
ZSH_AUTOSUGGEST_HIGHLIGHT_STYLE="fg=7"          # recessive grey (matches the editor palette)
...
ZSH_HIGHLIGHT_STYLES[bracket-level-1]='fg=7'
ZSH_HIGHLIGHT_STYLES[bracket-level-2]='fg=7'
ZSH_HIGHLIGHT_STYLES[bracket-level-3]='fg=7'
ZSH_HIGHLIGHT_STYLES[bracket-level-4]='fg=7'
ZSH_HIGHLIGHT_STYLES[bracket-error]='fg=7'
# <--
# <--
