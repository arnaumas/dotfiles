{
  keymaps = [
    ...
    }
    {
      ...
      key = "u";
      action.__raw = "function() vim.cmd[[ silent undo ]] end";
    }
    {
      mode = [
        "n"
    ...
    }
    {
      mode = "n";
      key = "<leader>+";
      action.__raw = "function() vim.cmd.resize('+5') end";
    }
    {
      mode = "n";
      key = "<leader>-";
    ...
    # buffer
    {
      mode = "n";
      key = "<leader>w";
      action.__raw = "function() vim.cmd[[ silent update ]] end";
    ...
    }
    {
      mode = "n";
      key = "<leader>Q";
      action.__raw = "function() vim.cmd.quit({ bang = true }) end";
